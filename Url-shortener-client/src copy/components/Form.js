...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedKey = nanoid(4);
        var generatedURL = "shrinkster-49b20838832d.herokuapp.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "shrinkster-49b20838832d.herokuapp.com/" + this.state.preferedAlias
        }
    ...
    validateInput = async () => {
        ...
        //validate url pt2
        const longURLWithAlias = this.state.generatedURL + this.state.preferedAlias;
    
        if (this.state.longURL.length < longURLWithAlias.length) {
            errors.push("longURL");
            errorMessages['longURL'] = 'The long URL must not be shorter than the generated URL plus alias.';
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    ...
                    <div className="form-group">
                        <label htmlFor="basic-url">Your Generated URL</label>
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">shrinkster-49b20838832d.herokuapp.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
                                ...
                                type="text" placeholder="eg. 2r4g (Optional)"
                            />
                        </div>
                        <div
                            className={
